...
Game = (function() {
  ...
  Game.prototype.appendBrave = function(brave) {
    ...
    braveObject.addFrameListener(function(t, dt) {
      ...
      gameTimeInterval = _this.trifolium.tickInterval / 1000.0 * _this.canvas.fps;
  ...
  Game.prototype.braveCompleteAction = function(brave, action, result) {
    var actionEffect, arrivalSpot, braveObject, circleRadiusMax, effectTime,
      _this = this;
    braveObject = this.braveObjectForId(brave.id);
    circleRadiusMax = 40.0;
    effectTime = 800;
    actionEffect = new Circle(1 * this.mapScale, {
      x: 0,
      y: 0,
