...
gamedate = function(time) {
  var day, gameDay, gameHours, gameMonth, gameTime, gameYear, hours, minutes, month, unixTime, year;
  ...
  return "" + year + "年" + month + "月" + day + "日 " + hours + ":" + minutes + " (" + (time.getHours()) + ":" + (time.getMinutes()) + ":" + (time.getSeconds()) + ")";
};
