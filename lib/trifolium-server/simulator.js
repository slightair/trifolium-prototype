...
Simulator = (function(_super) {
  ...
  Simulator.prototype.start = function(config) {
    var brave, braveNameDict, dungeon, dungeonInfo, dungeonList, eventInfo, i, itemDict, job, numBraves, simulator, time, _i, _len, _ref, _results;
