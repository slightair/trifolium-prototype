var Action, Brave, MoveAction, SearchAction, Simulator, Spot, WaitAction, _ref;
...
Simulator = (function() {
  ...
  function Simulator(config) {
    ...
    spotInfoList = config.spotInfoList, routeInfoList = config.routeInfoList, spawnSpotName = config.spawnSpotName, braveNameDictionary = config.braveNameDictionary, numBraves = config.numBraves, this.tickInterval = config.tickInterval;
