var EventInfo, EventInfoSchema, EventLog, EventLogSchema, ItemCreator, Schema, SearchEvent, gamedate, mongoose;

mongoose = require('mongoose');

gamedate = require('../util').gamedate;
...
EventLogSchema.virtual('gamedate').get(function() {
  return gamedate(this.date);
});
