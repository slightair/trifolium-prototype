...
Brave = (function(_super) {
  ...
  Brave.prototype.tick = function() {
    ...
    if (this.action != null) {
      ...
      if (this.actionProcess > 1.0) this.actionProcess = 1.0;
  ...
  Brave.prototype.details = function() {
    ...
    return {
      ...
      action: this.action ? this.action.details() : null,
      actionProcess: this.actionProcess,
      spot: (_ref = this.spot) != null ? _ref.id : void 0,
      destination: (_ref2 = this.destination) != null ? _ref2.id : void 0
    };
  };
