var Brave, BraveCreator, BraveSchema, ObjectId, Schema, crypto, mongoose, step;
...
BraveCreator = (function() {
  ...
  BraveCreator.prototype.createBraves = function(infoList, next) {
    var braves, info, saveBraveFunctions, _i, _len,
      _this = this;
    saveBraveFunctions = [];
    braves = [];
    for (_i = 0, _len = infoList.length; _i < _len; _i++) {
      info = infoList[_i];
      saveBraveFunctions.push(function(done) {
